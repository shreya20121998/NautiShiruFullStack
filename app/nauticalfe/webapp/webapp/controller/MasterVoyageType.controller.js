...
sap.ui.define(
    ...
    function (BaseController, ODataModel, Context, MessageBox, ODataContextBinding, MessageToast) {
      ...
      return BaseController.extend("nauticalfe.controller.MasterVoyageType", {
        ...
        createData: function () {
          console.log("v2 crete fn called");

          var ID = rowData.VOYCD

          var deptname = rowData.VOYDES
          ...
          odataModel.create("/VoyTypeSet", data, {
              ...
              error: function (error) {
                  ...
                  MessageToast.show("Error while creating the data", error);
